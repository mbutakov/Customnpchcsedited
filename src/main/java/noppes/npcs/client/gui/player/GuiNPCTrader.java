    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		for(int slot = 0; slot < 24; slot++){
			...
			if(item != null && sold != null){
	            ...
	            if(item2 != null){
	            	itemRender.renderItemAndEffectIntoGUI(fontRendererObj, mc.renderEngine, item2, x - 5, y + 1);
		        	itemRender.renderItemOverlayIntoGUI(fontRendererObj, mc.renderEngine, item2, x - 5, y + 1);
	            }
		        GL11.glColor4f(1, 1, 1, 1);
		        itemRender.renderItemAndEffectIntoGUI(fontRendererObj, mc.renderEngine, item, x + 13, y + 1);
		        itemRender.renderItemOverlayIntoGUI(fontRendererObj, mc.renderEngine, item, x + 12, y + 1);
	            RenderHelper.disableStandardItemLighting(); 
	
	            fontRendererObj.drawString("=", x + 31, y + 5, CustomNpcResourceListener.DefaultTextColor);
